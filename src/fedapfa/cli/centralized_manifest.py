"""Shell-friendly access to the strict centralized manifest expansion."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate and expand the centralized scientific manifest.")
    parser.add_argument("action", choices=("validate", "count", "task"))
    parser.add_argument("--manifest", required=True)
    parser.add_argument("--index", type=int)
    args = parser.parse_args()
    tasks = load_centralized_manifest(args.manifest)
